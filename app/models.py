...
class AttendanceRecord(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    zk_user_id = db.Column(db.String(20), nullable=False, index=True)
    employee_id = db.Column(db.String(20), db.ForeignKey('employees.employee_id'), nullable=True, index=True)
